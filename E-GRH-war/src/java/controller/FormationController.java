...
public class FormationController implements Serializable {
    ...
    public FormationController() {
     ...
     public List<Competence> getDetComp()
    {
        return ejbFacade.findCompetenceOfCategorie(current.getCategorie());
    }
    
     public List<TypesousFormation> getTypeSFormation()
     {
         return ejbFacade.findSousTypeOfTypeFormation(current.getTypeformation());
     }
